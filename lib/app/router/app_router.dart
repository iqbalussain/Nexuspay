...
const mobilePrimaryIndices = <int>[0, 5, 6, 7];
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/timesheets',
            builder: (context, state) =>
                const PlaceholderScreen(title: 'Timesheets'),
          ),
          GoRoute(
            path: '/approvals',
            builder: (context, state) =>
                const PlaceholderScreen(title: 'Approvals'),
          ),
          GoRoute(
            path: '/payroll',
            builder: (context, state) =>
          ...
          GoRoute(
            path: '/audit',
            builder: (context, state) =>
                const PlaceholderScreen(title: 'Audit'),
          ),
          GoRoute(
            path: '/settings',
            builder: (context, state) =>
